...
# Open the video file
cap = cv2.VideoCapture('sunny_road.mp4')
...
while cap.isOpened():
    ...
    results = model.track(frame, persist=True, classes = [1,2,3,5,6,7], tracker="bytetrack.yaml") #maintain only transportation relevant classes  
    print(results)
